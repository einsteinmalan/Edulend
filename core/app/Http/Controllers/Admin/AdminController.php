...
class AdminController extends Controller
{
    ...
    public function dashboards()
    {
        ...
        return view('admin.dashboards', compact('pageTitle', 'widget', 'report', 'withdrawals', 'chart','payment','paymentWithdraw','depositsMonth','withdrawalMonth','months','deposits'));
    }
    ...
    public function requestReport()
    {
        ...
        if ($response->status == 'error') {
            return redirect()->route('admin.dashboards')->withErrors($response->message);
        }
