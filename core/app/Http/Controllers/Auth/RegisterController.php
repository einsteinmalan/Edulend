...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function register(Request $request)
    {
        ...
        //Usr second approach to create user

       /* $userr = new User();
        $userr->firstname = $request->firstname;

        $userr->lastname = $request->title;
        $userr->category = $request->category;
        $userr->email = $request->email;
        $userr->mobile = $request->mobile_code.$request->mobile;
        $userr->password = $request->password;
        $userr->mobile_code = $request->mobile_code;
        $userr->country_code = $request->country_code;
        $userr->zip = $request->zip;
        $userr->city = $request->city;
        $userr->save();*/
